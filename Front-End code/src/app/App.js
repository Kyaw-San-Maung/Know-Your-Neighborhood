...
import TermsAndCondition from '../kyn/TermsAndCondition';
import AddStore from '../kyn/AddStore';
      ...
      <div className="app">
        ...
        <div className="app-body">
          <Switch>
            ...
            <Route path="/terms" component={TermsAndCondition}></Route>
            <Route path="/addStore" component={AddStore}></Route>
